        ...
        <div class="w-full max-w-2xl px-6 py-12">
            ...
            <div class="w-full px-0 md:px-6 py-12">
                <div class="flex items-center bg-gray-200">
                    ...
                    <div class="w-1/3 text-right text-gray-600 py-2 px-4 font-semibold">Professeur</div>
                </div>
            ...
            <div class="w-full px-0 md:px-6 py-12">
                <div class="flex items-center bg-gray-200">
                    ...
                    <div class="w-1/4 text-left text-gray-600 py-2 px-4 font-semibold">Professeur</div>
