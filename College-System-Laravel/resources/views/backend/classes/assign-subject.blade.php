...
@section('content')
    <div class="roles">
        ...
        <div class="flex items-center justify-between mb-6">
            <div>
                <h2 class="text-gray-700 uppercase font-bold">Assigner Sujet</h2>
            </div>
        ...
        <div class="w-full py-12">
            ...
            <div class="flex items-center bg-gray-200">
                <div class="w-1/4 text-left text-gray-600 py-2 px-4 font-semibold">Nom</div>
                <div class="w-1/4 text-left text-gray-600 py-2 px-4 font-semibold">Email</div>
                <div class="w-1/4 text-right text-gray-600 py-2 px-4 font-semibold">telephone</div>
